...
const Modal = ({item, show, protein, setProtein, fat, setFat, carb, setCarb, calories, setCalories}) => {
  ...
  return (
    <div id="dish">
        ...
        <div className="p">
            <p><button className='btn btn-danger' onClick={() => {setCalories(calories + item.nutrition.nutrients[0].amount)}}>{item.nutrition.nutrients[0].name}</button>
            ...
            <p><button className='btn btn-danger' onClick={() => {setFat(fat + item.nutrition.nutrients[1].amount)}}>{item.nutrition.nutrients[1].name}</button>
            ...
            <p><button className='btn btn-danger' onClick={() => {setCarb(carb + item.nutrition.nutrients[3].amount)}}>{item.nutrition.nutrients[3].name}</button>
            ...
            <p><button className='btn btn-danger' onClick={() => setProtein(protein + item.nutrition.nutrients[8].amount)}>{item.nutrition.nutrients[8].name}</button>
